  ...
  return (
    <ManageSceneShell scope="APP" current="import-export">
      <section className="space-y-4">
        <h1 className="text-xl font-semibold text-slate-900">应用导入导出</h1>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-3 rounded border border-slate-200 bg-white p-4">
            ...
            <div className="flex flex-wrap gap-2 text-sm">
              <Link
                href="/api/export?scope=APP&format=json"
                className="rounded border border-slate-300 px-3 py-1.5 text-slate-700 hover:bg-slate-50"
              >
                导出 JSON
              </Link>
              <Link
                href="/api/export?scope=APP&format=csv"
                className="rounded border border-slate-300 px-3 py-1.5 text-slate-700 hover:bg-slate-50"
              >
                导出 CSV
              </Link>
              <Link
                href="/api/export?scope=APP&format=html"
                className="rounded border border-slate-300 px-3 py-1.5 text-slate-700 hover:bg-slate-50"
              >
                导出 HTML
              </Link>
